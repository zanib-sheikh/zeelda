...
>
  ...
  <div className="flex items-start bg-white w-full gap-6 py-6 px-14  mx-auto">
      ...
      <div className="w-[560px] h-[400px] flex flex-col  justify-between">
      ...
      >
        ...
        {/* Comments List (No Scrollbar, Flex to Fit Content) */}
